...
# 110 "MCAL_Layer/CCP1/hal_ccp1.h"
...
(PIR1bits.CCP1IF = 0);
CCPI_Interrupt_Hundeler = ccp1_obj->CCP1_Interrupt_Hundeler;
# 160 "MCAL_Layer/CCP1/hal_ccp1.c"
  (INTCONbits.GIE = 1);
  (INTCONbits.PEIE = 0);
...
if(ccp1_obj->ccp1_mode == CCP1_PWM_MODE_SELECTED){
         if(ccp1_obj->ccp1_mode_variant == ((uint_8)0x0C)){
         (CCP1CONbits.CCP1M = ((uint_8)0x0C));
 PR2 = (uint_8)((4000000UL/(ccp1_obj->PWM_Freq * 4.0 * ccp1_obj->timer2_prescaler_value * ccp1_obj->timer2_postscaler_value))-1);
         }
         else{}
         ret = gpio_pin_intialize(&(ccp1_obj->ccp1_pin));
...
(PIR1bits.CCP1IF = 0);
CCPI_Interrupt_Hundeler = ccp1_obj->CCP1_Interrupt_Hundeler;
# 253 "MCAL_Layer/CCP1/hal_ccp1.c"
  (INTCONbits.GIE = 1);
  (INTCONbits.PEIE = 0);
