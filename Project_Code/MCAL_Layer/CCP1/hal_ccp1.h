...
#define CCP1_MODULE_DISABLE                  ((uint_8)0x00)
#define CCP1_CAPTURE_MODE_1_FALLING_EDGE     ((uint_8)0x04)
#define CCP1_CAPTURE_MODE_1_RISING_EDGE      ((uint_8)0x05)
#define CCP1_CAPTURE_MODE_4_RISING_EDGE      ((uint_8)0x06)
#define CCP1_CAPTURE_MODE_16_RISING_EDGE     ((uint_8)0x07)
#define CCP1_COMPARE_MODE_SET_PIN_LOW        ((uint_8)0x08)
#define CCP1_COMPARE_MODE_SET_PIN_HIGH       ((uint_8)0x09)
#define CCP1_COMPARE_MODE_TOGGLE_ON_MATCH    ((uint_8)0x02)
#define CCP1_COMPARE_MODE_GEN_SW_INTERRUPT   ((uint_8)0x0A)
#define CCP1_COMPARE_MODE_GEN_EVENT          ((uint_8)0x0B)
#define CCP1_PWM_MODE                        ((uint_8)0x0C)
